...
the file the container writes as `prod/raw/postings/2026-08-12.json` is the
file dbt reads at `/Volumes/<your catalog>/landing/prod/postings/`. One copy of
...
writes as `prod/raw/postings/2026-08-12.json` is the file dbt reads at
`/Volumes/<catalog>/landing/prod/postings/`. One copy of the bytes, two ways to
